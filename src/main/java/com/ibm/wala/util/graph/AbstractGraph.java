...
public abstract class AbstractGraph<T> implements Graph<T> {
  ...
  public abstract NodeManager<T> getNodeManager();

  /** @return the object which manages edges in the graph */
  public abstract EdgeManager<T> getEdgeManager();
   ...
   */
    // @Override
    // public T addEdge(T src, T dst) throws IllegalArgumentException {
    //return getEdgeManager().addEdge(src, dst);
    //}
   ...
   */
    // @Override
    //public boolean removeEdge(T src, T dst) throws IllegalArgumentException {
    //return getEdgeManager().removeEdge(src, dst);
    //}
